...
**************************************************/
public function createRegistration($person_id, $event_id, $quantity, $last_modified_by, $last_modified_date, $created_by, $created_date, $index){
	...
	$sql = "INSERT INTO $this->table (PERSON_ID, EVENT_ID, QUANTITY, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, CREATED_BY, CREATED_DATE, INDEX) VALUES ($person_id, $event_id, $quantity, '$last_modified_by', $last_modified_date, '$created_by', $created_date, $index)";
...
public function getRegistrationByIndex($index){
